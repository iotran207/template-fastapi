...
# WARNING: Ensure imports from `template_fastapi` comes after this line
from template_fastapi import app, settings, db  # noqa
from template_fastapi.cli import create_user, cli  # noqa
